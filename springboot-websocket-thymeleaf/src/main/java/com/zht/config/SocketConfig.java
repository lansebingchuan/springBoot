...
import com.zht.interceptor.MyPrincipalHandshakeHandler;
import com.zht.interceptor.WebSocketChannelInterceptor;
import com.zht.interceptor.WebSocketHandshakeInterceptor;
...
public class SocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        /**
         * 1、将 /server名称/stomp/websocketJS 作为客户端注册stomp的端点
         * 2、设置可以跨域
         * 3、设置拦截器，这个拦截器可以获取session
         * 4、withSockJS()表示支持socktJS访问
         */
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        // 线程名前缀
        poolTaskScheduler.setThreadNamePrefix("websocket-heartbeat-thread-");
        // 初始化
        ...
        registry.enableSimpleBroker("/topicTest", "/userTest")
                ...
                .setTaskScheduler(poolTaskScheduler);
